...
export class SitumConversionArea {
  floorIdentifier: number;
  topLeft: object;
  topRight: object;
  bottomLeft: object;
...
export class DirectionsOptions {
...
export class OutdoorLocationOptions {
