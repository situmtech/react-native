...
const testPoint = (pointLocal) => {
  expect(typeof pointLocal.buildingIdentifier).toBe("string");
  expect(typeof pointLocal.cartesianCoordinate).toBe("object");
  expect(typeof pointLocal.coordinate).toBe("object");
  expect(typeof pointLocal.floorIdentifier).toBe("string");
  expect(typeof pointLocal.isIndoor).toBe("boolean");
  expect(typeof pointLocal.isOutdoor).toBe("boolean");
  testCartesianCoordinate(pointLocal.cartesianCoordinate);
  testCoordinate(pointLocal.coordinate);
};
